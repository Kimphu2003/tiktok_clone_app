...
class _VideoScreenState extends State<VideoScreen> {
            ...
            return Stack(
              children: [
                ...
                PageView(
                  ...
                  children: [
                    _buildFeed(size, 'Đang theo dõi', _followingController, isInPipMode),
                    _buildFeed(size, 'Dành cho bạn', _forYouController, isInPipMode),
                  ],
                ),
  ...
  Obx _buildFeed(Size size, String label, PageController controller, bool isInPipMode) {
    return Obx(() {
      final allVideos = videoController.videoList;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildCompactButtonWithCount(
                                ...
                                color: videoController.isVideoFavorited(data.videoId)
                                    ? Colors.yellow
                                    : Colors.white,
                                onTap: () {
                                  debugPrint('🔖 Bookmark button tapped');
                                  videoController.toggleFavoriteVideo(data.videoId);
                                },
                              ),
                              const SizedBox(height: 6),
